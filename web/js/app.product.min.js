...
function(a){a.preventDefault();"undefined"!==typeof _gaq&&_gaq.push(["_trackEvent","QuickOrder","Open"]);l?$("#order1click-container").lightbox_me({centered:!0}):k($(this).attr("href"))});$("#order1click-form").bind("submit",function(a){a.preventDefault();$(this).ajaxSubmit({beforeSubmit:function(){var a=$("#order1click-form").find("input:submit");a.attr("disabled",!0);a.val("Оформляю заказ...")},success:function(a){a.success?a.data&&($("#order1click-container").find("h2").html(a.data.title),$("#order1click-form").replaceWith(a.data.content),
runAnalitics&&runAnalitics()):(a.data&&$("#order1click-form").html(a.data.form),a=$("#order1click-form").find("input:submit"),a.attr("disabled",!1),a.val("Оформить заказ"),$("#warn").length||(a=$('<span id="warn" style="color:red">').html("Не удалось оформить заказ. Приносим свои извинения! Повторите попытку или обратитесь с заказом в контакт cENTER&nbsp;8&nbsp;(800)&nbsp;700&nbsp;00&nbsp;09"),$(".bFormB2").before(a)))},error:function(){var a=$("#order1click-form").find("input:submit");a.attr("disabled",
!1);a.val("Попробовать еще раз")}})});if($("#gMap").length){$("#gMap").bind({create:function(a,b,d,f){var c=$(this),a={zoom:11,center:new google.maps.LatLng(b.latitude,b.longitude),scrollwheel:!1,mapTypeId:google.maps.MapTypeId.ROADMAP,mapTypeControlOptions:{style:google.maps.MapTypeControlStyle.DROPDOWN_MENU}},e=new google.maps.Map(document.getElementById(c.attr("id")),a),a=new InfoBox({disableAutoPan:!1,maxWidth:0,pixelOffset:new google.maps.Size(-11,-108),zIndex:null,boxStyle:{opacity:0.85,width:"280px"},
closeBoxURL:"http://www.google.com/intl/en_us/mapfiles/close.gif",infoBoxClearance:new google.maps.Size(1,1),isHidden:!1,pane:"floatShadow",enableEventPropagation:!0}),g=function(){var a=d[this.id];c.trigger("showMarkers");c.trigger("infoWindow",[this,a])};c.data("markers",[]);$.each(d,function(a,b){var d=new google.maps.Marker({position:new google.maps.LatLng(b.latitude,b.longitude),map:e,title:b.name,icon:"/images/marker.png",id:b.id});google.maps.event.addListener(d,"click",g);c.data("markers").push(d)});
google.maps.event.addListener(e,"bounds_changed",function(){});google.maps.event.addListener(e,"click",function(){});google.maps.event.addListener(a,"closeclick",function(){c.trigger("showMarkers")});c.data("map",e);c.data("infoWindow",a);c.data("infoWindowTemplate",f)},move:function(){$(this).data("map")},infoWindow:function(a,b,d){var f=$(this),a=f.data("map"),c=f.data("infoWindow"),f=f.data("infoWindowTemplate");b.setMap(null);$.each(f.find("[data-name]"),function(a,b){b.innerHTML=d[$(b).data("name")]});
c.setContent(f.prop("innerHTML"));c.open(a,b)},showMarkers:function(){var a=$(this);$.each(a.data("markers"),function(b,d){null==d.map&&d.setMap(a.data("map"))})}});i=$("#gMap");i.trigger("create",[$("#map-center").data("content"),$("#map-markers").data("content"),$("#map-info_window-container")]);i.delegate(".shopchoose","click",function(a){m(a.target)});i[0].addEventListener("touchstart",function(a){a.target.className.match("shopchoose")&&m(a.target)},!1);var m=function(a){k($(a).parent().find(".shopnum").text())};
$(".bInShopLine__eButton a").bind("click",function(a){a.preventDefault();k($(this).attr("href"))});$(".bInShop__eCurrent a").click(function(){$.getJSON("/region/init",function(a){if(!a.success)return!1;var a=a.data,b=$("<div>").addClass("graying").css({opacity:"0.5"}),d=$('<div class="bCityPopupWrap">').html('<div class="hideblock bCityPopup"><i title="Закрыть" class="close">Закрыть</i><div class="title">Привет, из какого ты города?</div></div></div>');d.find(".close").click(function(){$(".graying").remove();
