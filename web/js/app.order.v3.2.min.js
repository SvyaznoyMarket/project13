...
onShopSelected:function(){},onMapClosed:function(b){var d=$(".bBuyingLine__eRadio:checked");regionMap.closeMap();DeliveryMap.onShopSelected.apply(this,[d.val(),b])},validate:function(b,d){$("#order-form");var e=!1;b.is(":radio")&&!b.is(":checked")&&1<b.length?(e=!0,showError(b.first().parent().parent(),d,!1)):b.is(":checkbox")&&!b.is(":checked")&&1==b.length?(e=!0,showError(b.first().parent().parent(),d,!1)):b.is(":text")&&!b.val()&&(e=!0,showError(b,d,!0));return e}};window.regionMap=new MapWithShops($("#map-center").data("content"),
$("#map-info_window-container"),"mapPopup",DeliveryMap.onMapClosed);$("#order-loader-holder").html("");$("#order-form-part1").show();$("body").delegate(".bImgButton.mBacket","click",function(b){b.preventDefault();var d=$(this),e=d.data("token");$.ajax({async:!1,url:d.attr("href"),success:function(){d.closest(".order-item-container").hide("medium",function(){$(this).remove()})}});var g=DeliveryMap.data();$.each(g.deliveryTypes,function(c,a){$.each(a.items,function(c,b){b==e&&(g.deliveryTypes[a.token].items.splice(c,
1),delete g.items[b])})});b=$.inArray(e,g.unavailable);-1!==b&&g.unavailable.splice(b,1);DeliveryMap.data(g);DeliveryMap.render()});$("body").delegate(".bBuyingLine label","click",function(b){if($(b.target).is("input")&&("radio"==$(this).find("input").attr("type")&&(b=$('.mChecked input[name="'+$(this).find("input").attr("name")+'"]'),b.length&&b.each(function(b,d){$(d).parent("label").removeClass("mChecked")}),$(this).addClass("mChecked")),"checkbox"==$(this).find("input").attr("type")&&$(this).toggleClass("mChecked"),
