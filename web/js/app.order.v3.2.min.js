...
$("#payment_method_5-field").show():($("#payment_method_5-field").hide(),$("#payment_method_5-field").find("input").is(":checked")&&($("#payment_method_5-field").find("input").removeAttr("checked"),$("#payment_method_5-field").find(".mChecked").removeClass("mChecked")))},checkAddressFiled:function(){0<$('.order-delivery-holder[data-type="standart"]:visible').length?$("#addressField").show():$("#addressField").hide()}};var l=$("#mapPopup_shopInfo"),i=$("#map-info_window-container"),o=$("#order-delivery_map-data").data().value.shops,
