...
d){var e=this.data(),g=[];for(i=0;i<e.deliveryTypes[b].items.length;i++){var c=e.deliveryTypes[b].items[i];array_key_exists(d,e.items[c].deliveries)?e.deliveryTypes[d].items.push(c):g.push(c)}e.deliveryTypes[b].items=g;this.data(e);return g},getDeliveryPrice:function(b){var d=this.data(),e=0;$.each(b.items,function(g,c){var a=d.items[c].deliveries[b.token].price;a>e&&(e=a)});return parseInt(e)},getDeliveryTotal:function(b){var d=this.data(),e=0;$.each(b.items,function(b,c){e+=d.items[c].total});return parseInt(e)},
getDeliveryDate:function(b){var d=this.data(),e=null;$.each(b.items,function(g,c){var a=[];$.each(d.items[c].deliveries[b.token].dates,function(c,b){a.push(b.value)});e=null===e?a:array_intersect(e,a)});return null===e?[]:array_values(e)},getDeliveryInterval:function(b,d){var e=this.data(),g={};$.each(b.items,function(c,a){$.each(e.items[a].deliveries[b.token].dates,function(a,c){c.value==d&&$.each(c.intervals,function(a,c){g[c.start_at+","+c.end_at]=c})})});return g},render:function(){var b=this,
