...
1),delete a.items[g])})});var b=$.inArray(c,a.unavailable);-1!==b&&a.unavailable.splice(b,1);DeliveryMap.data(a);DeliveryMap.render();DeliveryMap.onDeliveryBlockChange()};$.ajax({async:!1,url:b.attr("href"),success:function(){b.closest(".order-item-container").hide("medium",d)}})});$("body").delegate(".bBuyingLine label","click",function(a){if($(a.target).is("input")&&("radio"==$(this).find("input").attr("type")&&(a=$('.mChecked input[name="'+$(this).find("input").attr("name")+'"]'),a.length&&a.each(function(a,
b){$(b).parent("label").removeClass("mChecked")}),$(this).addClass("mChecked")),"checkbox"==$(this).find("input").attr("type")&&$(this).toggleClass("mChecked"),a=$(this).find('input[type="radio"][data-delivery-type]'),a.length)){$("#order-submit").addClass("disable");var b=$("#order-form").data("deliveryMapUrl");$("#order-form-part2").hide();$(".order-shop-button:first").hide();"self"==a.data("deliveryType")?$(".order-shop-button:first").show():($("#order-loader").clone().appendTo("#order-loader-holder").show(),
