...
clearTimeout(c);b&&a.markers[b]&&(c=setTimeout(function(){a.showInfoWindow(a.markers[b])},500),$("#mapPopup_shopInfo").data("timer",c))});(function(){a.positionC=new google.maps.LatLng(g.latitude,g.longitude);var b={zoom:11,center:a.positionC,scrollwheel:!1,mapTypeId:google.maps.MapTypeId.ROADMAP,mapTypeControlOptions:{style:google.maps.MapTypeControlStyle.DROPDOWN_MENU}};a.mapWS=new google.maps.Map(document.getElementById(j),b);a.infoWindow=new google.maps.InfoWindow({maxWidth:400,disableAutoPan:!1})})()}
;
