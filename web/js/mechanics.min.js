...
b.name),b.link&&$(".point6",d).attr("href",b.link),b.vcomp&&$(".point4 b",d).html(b.vcomp),b.vwish&&$(".point3 b",d).html(b.vwish),b.sum&&($("#sum",d).html(f(b.sum)),$(".total").show()),b.vitems&&($(".point2 b",d).html(b.vitems),this.fillTopBlock()),b.bingo&&b.bingo.id&&(a=$("<li>").addClass("fl").html('<a class="point point5" href=""><b></b></a>'),$(".lightboxmenu").prepend(a),a.bind("click",function(){i.bingo(b.bingo);return!1}),g=new Flybox(d),i.bingo(b.bingo)))};this.authorized=function(){return b.name?
!0:!1};this.update();c=new Flybox(d)}
