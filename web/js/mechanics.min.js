...
this.getBasket=function(a){a.price+="";var e=$(".goodsbarbig").length?"product":"catalog";"undefined"!==typeof _gaq&&_gaq.push(["_trackEvent","Add2Basket",e,a.title+" "+a.id,Math.round(a.price.replace(/\D/g,""))]);c.clear();a.price=a.price.replace(/\s+/,"");b.basket=a;b.sum=1*a.sum;$(".total").show();a.sum=f(b.sum);a.price=f(a.price);b.vitems=a.vitems;c.updateItem(a);$("#sum",d).html(a.sum);$(".point2 b",d).html(a.vitems);"f1"in a?"only"in a.f1?c.showBasketF1(a.f1):c.showBasket(a.f1):c.showBasket()};
this.getWishes=function(a){c.clear();a.price=a.price.replace(/\s/,"");a.price=f(a.price);b.wishes=a;b.vwish++;a.vwish=b.vwish;c.updateItem(a);$(".point3 b",d).html(b.vwish);c.showWishes()};this.bingo=function(a){c&&c.clear();a.price=f(a.price);b.bingo=a;g.updateItem(a);g.showBingo()};this.getComparing=function(){c.clear();g&&g.clear();c.showComparing()};this.clear=function(){c.clear();g&&g.clear()};this.getContainers=function(){$(".dropbox",d).show()};this.hideContainers=function(){$(".dropbox",d).hide()};
this.toFire=function(a){h=a;$(".dropbox",d).addClass("active").find("p").html("Отпустите мышь")};this.putOut=function(a){$($(".dropbox",d)[a-1]).removeClass("active").find("p").html("Перетащите сюда")};this.putOutBoxes=function(){if(h){for(var a=1;4>a;a++)i.putOut(a);h=0}};this.gravitation=function(){return h?h:!1};this.update=function(a){a&&(b=a);b&&(b.name&&$(".fl .point",d).removeClass("point1").addClass("point6").html("<b></b>"+b.name),b.link&&$(".point6",d).attr("href",b.link),b.vcomp&&$(".point4 b",
d).html(b.vcomp),b.vwish&&$(".point3 b",d).html(b.vwish),b.sum&&($("#sum",d).html(f(b.sum)),$(".total").show()),b.vitems&&$(".point2 b",d).html(b.vitems),b.bingo&&b.bingo.id&&(a=$("<li>").addClass("fl").html('<a class="point point5" href=""><b></b></a>'),$(".lightboxmenu").prepend(a),a.bind("click",function(){i.bingo(b.bingo);return!1}),g=new Flybox(d),i.bingo(b.bingo)))};this.update();c=new Flybox(d)}
...
c.vitems+'<div class="clear pb10"></div><div class="ar"><a class="button bigbuttonlink" value="" href="'+j+'">Оформить заказ</a></div>';e.css({left:"588px",width:"290px"});f.css("left","132px");this.fillup(h);e.fadeIn(500);g=setTimeout(b.jinny,5E3)};this.showBasketF1=function(a){if("undefined"===typeof a)return!1;h='<div class="font16 pb20">Только что был добавлен в корзину:</div>'+('<div class="bLiteboxF1"><div class="fl width70 bLiteboxF1__eWrap"><div class="bLiteboxF1__ePlus"></div><a href=""><img src="/images/f1info1.png" alt="" width="60" height="60" /></a></div><div class="ml70"><div class="pb5 bLiteboxF1__eG"><a href>'+
a.f1title+"</a></div><strong>"+a.f1price+' <span class="rubl">p</span></strong></div></div>')+'<div class="clear pb10"></div><div class="line pb5"></div><div class="fr">Сумма: '+c.sum+" Р</div>Всего товаров: "+c.vitems+'<div class="clear pb10"></div><div class="ar"><a class="button bigbuttonlink" value="" href="'+j+'">Оформить заказ</a></div>';e.css({left:"588px",width:"290px"});f.css("left","132px");this.fillup(h);e.fadeIn(500);g=setTimeout(b.jinny,5E3)};this.fillup=function(a){a=$("<div>").addClass("fillup").html(a);
e.append(a)};this.jinny=function(){e.fadeOut(500);setTimeout(function(){$(".fillup",e).remove()},550)};this.clear=function(){clearTimeout(g);e.hide();$(".fillup",e).remove()}}
...
function mediaLib(d){if(d.length){var e=this,f=null,i=!1,b=!1;this.show=function(g,c){if(b)switch(e.close(),g){case "image":$("<img>").attr("src",c).attr("id","gii").appendTo($(".photobox",d));f=new gigaimage($("#gii"),2,$(".scale",d));f.addZoom();break;case "360":i?lkmv.show():(lkmv.start(),i=!0)}else{var h=function(){};switch(g){case "image":h=e.openEnormous;break;case "360":h=e.open360}$(d).lightbox_me({centered:!0,onLoad:function(){h(c)},onClose:function(){e.close();b=!1},reallyBig:!0});b=!0}return!1};
this.close=function(){f&&(f.destroy(),f=null,$("#gii").remove());i&&lkmv&&lkmv.hide()};this.openEnormous=function(b){$("<img>").attr("src",b).attr("id","gii").appendTo($(".photobox",d));f=new gigaimage($("#gii"),2,$(".scale",d));f.addZoom()};this.open360=function(){i?lkmv.show():(lkmv.start(),i=!0)}}};
