...
m=true;a.cursorDrag()}c.bind({mousedown:function(a){a.preventDefault();b(a)}});typeof window.addEventListener!=="undefined"&&(c[0].addEventListener("touchstart",function(a){a.preventDefault();b(a)},false),c[0].addEventListener("touchmove",function(b){if(m)b.preventDefault(),a.action(b,{x:b.pageX-init.pageX,y:b.pageY-init.pageY},i,a.zoom),init.pageX=b.pageX,init.pageY=b.pageY},false),c[0].addEventListener("touchend",function(){m=false;a.cursorHand()},false))};this.addDrag();$(document).bind("mousemove.zoomer",
