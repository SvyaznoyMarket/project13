...
price:$(".goodsinfo .price").html(),img:$(".goodsphoto img.mainImg").attr("src")};b.f1=a;if(l)b.f1.only="yes";ltbx.getBasket(b);l||(l=!0,m())});return!1});$("a.bBacketServ__eMore",h).live("click",function(){var a=this;$.getJSON($(this).attr("href"),function(b){if(!b.success)return!0;var d=$(a).parent();i.find("td[ref="+d.attr("ref")+"]").find("input").val("Купить услугу").removeClass("active");d.remove();ltbx.update({sum:b.data.full_price});$("a.bBacketServ__eMore",h).length||h.find("h3").html("Выбирай услуги F1<br/>вместе с этим товаром")});
...
function(){var a=$("div.bInShop__eButton a.link1");a.html("<i> </i>"+a.html())});e.push("div.goodsinfosmall a.link1",$("div.goodsinfosmall").data("value"));"ANALYTICS"in window&&PubSub.subscribe("productBought",function(a,b){"gooReMaBuy"in ANALYTICS&&ANALYTICS.gooReMaBuy();"myThingsBuy"in ANALYTICS&&ANALYTICS.myThingsBuy(b)})});
