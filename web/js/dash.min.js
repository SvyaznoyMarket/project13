$(document).ready(function(){function m(a){a=$("div[ref="+a+"]");return{id:$(a).attr("ref"),title:$("h3 a",a).html(),price:$(".price",a).html(),img:$(".photo img",a).attr("src")}}var e="/user/shortinfo";if(!docCookies.hasItem("enter")||!docCookies.hasItem("enter_auth"))e+="?ts="+(new Date).getTime()+Math.floor(1E3*Math.random());var j={};if(void 0===window.Lightbox)return $(".lightboxinner").hide(),$.getJSON(e,function(a){if(a.success)if(a.data.name){var b={};b.user=a.data.name;a=tmpl("auth_tmpl",
