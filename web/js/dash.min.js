...
$(a).data("run",!0);g=$(".boxhover",a).attr("ref");o=setTimeout(function(){if($(a).data("run")){var d=1*b.attr("width"),c=1*b.attr("height");$(".boxhover .photo img",$(a)).css({width:d+3,height:c+3,top:"-1px"});$(a).css({position:"relative","z-index":2});$(a).children().fadeOut();$(".boxhover",a).fadeIn(200)}},200)}},mouseleave:function(){if(!$(this).hasClass("goodsline")&&!$(this).parent().hasClass("bigcarousel")){var a=$(".boxhover .photo img",this);if($(this).data("run")){clearTimeout(o);$(this).data("run",
!1);var b=1*a.attr("width"),a=1*a.attr("height");$(".boxhover .photo img",this).css({width:b+3,height:a+3});$(this).css("z-index",1);$(this).children().not(".boxhover").fadeIn();$(".boxhover",this).fadeOut("slow")}}}});$(".boxhover .lt").live("click",function(){if($(this).attr("data-url"))window.location.href=$(this).attr("data-url")});if($("div.bF1Info").length){var h=$("div.bF1Info"),i=$("div.bF1Block");$(".link1",h).click(function(){i.show();return!1});$(".close",i).click(function(){i.hide()});
...
link:a.data.link}),d&&d())});return!1})}};e.push("div.bServiceCardWrap input");e.push("div.goodsbarbig a.link1",$("div.goodsbarbig").data("value"),l);e.push("#bigpopup a.link1",$("div.popup_leftpanel").data("value"),l);e.push("div.bSet a.link1",$("div.bSet").data("value"),l);e.push("div.mServ a.link1",$("div.mServ").data("value"));e.push("div.bInShop__eButton a.link1",$("div.bInShop__eButton").data("value"),function(){var a=$("div.bInShop__eButton a.link1");a.html("<i> </i>"+a.html())});e.push("div.goodsinfosmall a.link1",
$("div.goodsinfosmall").data("value"))});
