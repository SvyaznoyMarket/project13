...
function(b,c){null==c.map&&c.setMap(a.data("map"))})}});var j=$("#gMap");j.trigger("create",[$("#map-center").data("content"),$("#map-markers").data("content"),$("#map-info_window-container")]);j.delegate(".shopchoose","click",function(a){q(a.target)});j[0].addEventListener("touchstart",function(a){a.target.className.match("shopchoose")&&q(a.target)},!1);var q=function(a){i($(a).parent().find(".shopnum").text())};$(".bInShopLine__eButton a").bind("click",function(a){a.preventDefault();i($(this).attr("href"))});
