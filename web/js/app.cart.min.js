...
var h=$(a.drop).attr("href");this.sum=$(a.sum).html().replace(/\s/,"");this.quantum=1*$(a.quan).html().replace(/\D/g,"");var i=(1*(1*b.sum/b.quantum)).toFixed(2);"price"in a&&(i=$(a.price).html().replace(/\s/,""));this.price=i;this.noview=!1;f+=1*this.sum;this.calculate=function(c){b.quantum=c;b.sum=i*c;$(a.sum).html(printPrice(b.sum));$(a.sum).typewriter(800,e)};this.clear=function(){g.remove();b.noview=!0;PubSub.publish("quantityChange",{q:0,id:b.id});c&&c();$.getJSON(h,function(b){$(a.drop).data("run",
!1);b.success?e():location.href=location.href})};this.update=function(c,g){var e=0<g?l:d;b.quantum+=g;$(a.quan).html(b.quantum+" шт.");b.calculate(b.quantum);f+=b.price*g;PubSub.publish("quantityChange",{q:b.quantum,id:b.id});if($("#selectCredit").length)var h="",h=1*$("#selectCredit").val()?"/1":"/0",e=e+h;$.getJSON(e,function(a){$(c).data("run",!1);if(!a.success)location.href=location.href})};$(a.drop).click(function(){$(a.drop).data("run")||($(a.drop).data("run",!0),b.clear());return!1});$(a.less).click(function(){$(this).data("run")||
