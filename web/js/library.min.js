...
(function(){function b(b){return 10>b?"0"+b:b}function a(b){f.lastIndex=0;return f.test(b)?'"'+b.replace(f,function(b){var a=d[b];return"string"===typeof a?a:"\\u"+("0000"+b.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+b+'"'}function c(b,m){var d,k,f,g,o=e,p,l=m[b];l&&"object"===typeof l&&"function"===typeof l.toJSON&&(l=l.toJSON(b));"function"===typeof h&&(l=h.call(m,b,l));switch(typeof l){case "string":return a(l);case "number":return isFinite(l)?""+l:"null";case "boolean":case "null":return""+l;
case "object":if(!l)return"null";e+=i;p=[];if("[object Array]"===Object.prototype.toString.apply(l)){g=l.length;for(d=0;d<g;d+=1)p[d]=c(d,l)||"null";f=0===p.length?"[]":e?"[\n"+e+p.join(",\n"+e)+"\n"+o+"]":"["+p.join(",")+"]";e=o;return f}if(h&&"object"===typeof h){g=h.length;for(d=0;d<g;d+=1)"string"===typeof h[d]&&(k=h[d],(f=c(k,l))&&p.push(a(k)+(e?": ":":")+f))}else for(k in l)Object.prototype.hasOwnProperty.call(l,k)&&(f=c(k,l))&&p.push(a(k)+(e?": ":":")+f);f=0===p.length?"{}":e?"{\n"+e+p.join(",\n"+
e)+"\n"+o+"}":"{"+p.join(",")+"}";e=o;return f}}if("function"!==typeof Date.prototype.toJSON)Date.prototype.toJSON=function(){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+b(this.getUTCMonth()+1)+"-"+b(this.getUTCDate())+"T"+b(this.getUTCHours())+":"+b(this.getUTCMinutes())+":"+b(this.getUTCSeconds())+"Z":null},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(){return this.valueOf()};var f=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
e,i,d={"":"\\b","\t":"\\t","\n":"\\n","":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},h;if("function"!==typeof JSON.stringify)JSON.stringify=function(b,a,d){var k;i=e="";if("number"===typeof d)for(k=0;k<d;k+=1)i+=" ";else"string"===typeof d&&(i=d);if((h=a)&&"function"!==typeof a&&("object"!==typeof a||"number"!==typeof a.length))throw Error("JSON.stringify");return c("",{"":b})};if("function"!==typeof JSON.parse)JSON.parse=function(){function b(a){return a.replace(/\\(?:u(.{4})|([^u]))/g,function(a,
b,e){return b?String.fromCharCode(parseInt(b,16)):f[e]})}var a,e,c,d,g,f={"\\":"\\",'"':'"',"/":"/",t:"\t",n:"\n",r:"\r",f:"",b:""},i={go:function(){a="ok"},firstokey:function(){d=g;a="colon"},okey:function(){d=g;a="colon"},ovalue:function(){a="ocomma"},firstavalue:function(){a="acomma"},avalue:function(){a="acomma"}},h={go:function(){a="ok"},ovalue:function(){a="ocomma"},firstavalue:function(){a="acomma"},avalue:function(){a="acomma"}},r={"{":{go:function(){e.push({state:"ok"});c={};a="firstokey"},
...
d){var f,k=/^[\x20\t\n\r]*(?:([,:\[\]{}]|true|false|null)|(-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)|"((?:[^\r\n\t\\\"]|\\(?:["\\\/trnfb]|u[0-9a-fA-F]{4}))*)")/;a="go";e=[];try{for(;;){f=k.exec(c);if(!f)break;if(f[1])r[f[1]][a]();else f[2]?(g=+f[2],h[a]()):(g=b(f[3]),i[a]());c=c.slice(f[0].length)}}catch(o){a=o}if("ok"!==a||/[^\x20\t\n\r]/.test(c))throw a instanceof SyntaxError?a:new SyntaxError("JSON");return"function"===typeof d?function s(a,b){var c,e,j=a[b];if(j&&"object"===typeof j)for(c in j)Object.prototype.hasOwnProperty.call(j,
c)&&(e=s(j,c),void 0!==e?j[c]=e:delete j[c]);return d.call(a,b,j)}({"":g},""):g}}()})();var PubSub={};
(function(b){b.version="1.0.1";var a={},c=-1,f=function(b,c,d){if(!a.hasOwnProperty(b))return!1;var f=function(){for(var d=a[b],f=function(a){return function(){throw a;}},h=0,k=d.length;h<k;h++)try{d[h].func(b,c)}catch(q){setTimeout(f(q),0)}};!0===d?f():setTimeout(f,0);return!0};b.publish=function(a,b){return f(a,b,!1)};b.publishSync=function(a,b){return f(a,b,!0)};b.subscribe=function(b,f){a.hasOwnProperty(b)||(a[b]=[]);var d=(++c).toString();a[b].push({token:d,func:f});return d};b.unsubscribe=function(b){for(var c in a)if(a.hasOwnProperty(c))for(var d=
...
function MapWithShops(b,a,c,f){var e=this,i=null,d=null,h=null,j=[],m=null,n=$("#"+c),k=a.prop("innerHTML");this.updateInfoWindowTemplate=function(b){f&&f(b);k=a.prop("innerHTML")};this.showInfobox=function(b){m&&m.setVisible(!0);var a=j[b].ref;m=a;b=j[a.id];a.setVisible(!1);e.updateInfoWindowTemplate(b);d.setContent(k);d.setPosition(a.position);d.open(i);google.maps.event.addListener(d,"closeclick",function(){a.setVisible(!0)})};this.hideInfobox=function(){d.close()};var q=[];this.addHandlerMarker=
function(b,a){q.push({event:b,callback:a})};this.showMarkers=function(b){n.show();$.each(j,function(b,a){"undefined"!==typeof a.ref&&a.ref.setMap(null)});j=b;google.maps.event.trigger(i,"resize");i.setCenter(h);var a=0,c=0,d=90,f=90,k=0;$.each(j,function(b,g){k++;if(g.latitude>a)a=g.latitude;if(g.longitude>c)c=g.longitude;if(g.latitude<d)d=g.latitude;if(g.longitude<f)f=g.longitude;var h=new google.maps.Marker({position:new google.maps.LatLng(g.latitude,g.longitude),map:i,title:g.name,icon:"/images/marker.png",
id:g.id});google.maps.event.addListener(h,"click",function(){e.showInfobox(this.id)});$.each(q,function(b,a){google.maps.event.addListener(h,a.event,function(){a.callback(g)})});j[h.id].ref=h});1===k&&(d-=0.001,d-=0.001,a=1*a+0.001,c=1*c+0.001);var b=new google.maps.LatLng(d,f),m=new google.maps.LatLng(a,c),b=new google.maps.LatLngBounds(b,m);k&&i.fitBounds(b)};this.closeMap=function(b){d.close();n.hide("blind",null,800,function(){b&&b()})};this.closePopupMap=function(b){d.close();b&&b()};this.addHandler=
function(b,a){n.delegate(b,"click",function(b){b.preventDefault();a(b.target)});(new brwsr).isTouch&&n[0].addEventListener("touchstart",function(c){c.preventDefault();c.target.is(b)&&a(c.target)},!1)};(function(){h=new google.maps.LatLng(b.latitude,b.longitude);var a={zoom:11,center:h,scrollwheel:!1,mapTypeId:google.maps.MapTypeId.ROADMAP,mapTypeControlOptions:{style:google.maps.MapTypeControlStyle.DROPDOWN_MENU}};i=new google.maps.Map(document.getElementById(c),a);d=new google.maps.InfoWindow({maxWidth:400,
...
function(){a.css({left:"3px",width:"874px"});c.css("left","374px");this.fillup($("#zaglu").html());a.fadeIn(1E3);i=setTimeout(e.jinny,7E3)};var n=$(".point2",b).attr("href");this.showBasket=function(b){if("undefined"!==typeof d.link)n=d.link;var f="";"undefined"!==typeof b&&(f='<br/><div class="bLiteboxF1"><div class="fl width70 bLiteboxF1__eWrap"><div class="bLiteboxF1__ePlus">+</div><a href=""><img src="/images/f1info1.png" alt="" width="60" height="60" /></a></div><div class="ml70"><div class="pb5 bLiteboxF1__eG"><a href>'+
...
d.vitems+'<div class="clear pb10"></div><div class="ar"><a class="button bigbuttonlink" value="" href="'+n+'">Оформить заказ</a></div>';a.css({left:"588px",width:"290px"});c.css("left","132px");this.fillup(h);a.fadeIn(500);i=setTimeout(e.jinny,5E3)};this.showBasketF1=function(b){if("undefined"===typeof b)return!1;h='<div class="font16 pb20">Только что был добавлен в корзину:</div>'+('<div class="bLiteboxF1"><div class="fl width70 bLiteboxF1__eWrap"><div class="bLiteboxF1__ePlus"></div><a href=""><img src="/images/f1info1.png" alt="" width="60" height="60" /></a></div><div class="ml70"><div class="pb5 bLiteboxF1__eG"><a href>'+
b.f1title+"</a></div><strong>"+b.f1price+' <span class="rubl">p</span></strong></div></div>')+'<div class="clear pb10"></div><div class="line pb5"></div><div class="fr">Сумма: '+d.sum+" Р</div>Всего товаров: "+d.vitems+'<div class="clear pb10"></div><div class="ar"><a class="button bigbuttonlink" value="" href="'+n+'">Оформить заказ</a></div>';a.css({left:"588px",width:"290px"});c.css("left","132px");this.fillup(h);a.fadeIn(500);i=setTimeout(e.jinny,5E3)};this.fillup=function(b){b=$("<div>").addClass("fillup").html(b);
a.append(b)};this.jinny=function(){a.fadeOut(500);setTimeout(function(){$(".fillup",a).remove()},550)};this.clear=function(){clearTimeout(i);a.hide();$(".fillup",a).remove()}}
function DDforLB(b,a){if(!b.length)return null;var c=this,f=!1,e=null,i=$(".dropbox");if(!i.length)return null;var d=[],h=0,j=null,m=$("<div>").addClass("dragbox").css("display","none"),e=$("<div>");m.append(e);$(b).append(m);var n=$("<div>").addClass("graying").css({display:"none",opacity:"0.5"});$(b).append(n);var k=0;this.cancel=function(){$(document).unbind("mousemove.dragitem")};$(document).bind("mouseup",function(a){"dragimg"==a.target.id&&c.cancel()});this.prepare=function(b,g,o){j=o;$(".boxhover[ref="+
j.id+"] a.link1").hasClass("active")||$(document).bind("mousemove.dragitem",function(j){j.preventDefault();if(f)e.css({left:j.pageX-30,top:j.pageY-k-30}),h=$(i[0]).offset().top,j.pageY+30>h-25&&j.pageX+30>d[0]-25&&j.pageX-30<d[0]+70+25?a.toFire(3):a.putOutBoxes();else if(25<Math.abs(b-j.pageX)||25<Math.abs(g-j.pageY))c.turnon(j.pageX,j.pageY),f=!0})};this.turnon=function(b,f){a.clear();n.show();k=n.offset().top;e.html($("<img>").css({width:60,height:60}).attr({id:"dragimg",width:60,height:60,alt:"",
src:j.img}));e.css({left:b-30,top:f-k-30});m.show();a.getContainers();for(var o=0;o<i.length;o++)d[o]=$(i[o]).offset().left;$(document).bind("mouseup.dragitem",function(){(fbox=a.gravitation())?($(document).unbind(".dragitem"),e.animate({left:d[0]+5,top:h-k+5},400,function(){c.finalize(fbox)})):c.turnoff()})};this.turnoff=function(){f=!1;n.fadeOut();m.hide();a.hideContainers();$(document).unbind(".dragitem")};this.finalize=function(b){setTimeout(function(){c.turnoff();switch(b){case 1:a.getComparing(j);
break;case 2:a.getWishes(j);break;case 3:$.getJSON($(".boxhover[ref="+j.id+"] a.link1").attr("href")+"/1",function(b){if(b.success&&a){var c=j;c.vitems=b.data.full_quantity;c.sum=b.data.full_price;a.getBasket(c)}})}},400)}}var ltbx=null;
...
DirectCredit={basketPull:[],output:null,input:null,init:function(b,a){if(!b||!a)return"incorrect input data";this.input=b;this.output=a;for(var c=0,f=b.length;c<f;c++)this.basketPull.push({id:b[c].id,price:b[c].price,count:b[c].quantity,type:b[c].type});this.sendCredit()},change:function(b,a){self=DirectCredit;if(0<a.q)self.findProduct(self.basketPull,a.id).count=a.q;else{var c=self.findProductKey(self.basketPull,a.id);self.basketPull.splice(c,1)}self.sendCredit()},findProduct:function(b,a){for(var c=
0,f=b.length;c<f;c++)if(b[c].id==a)return b[c];return-1},findProductKey:function(b,a){for(var c=0,f=b.length;c<f;c++)if(b[c].id==a)return c;return-1},sendCredit:function(){var b=this;dc_getCreditForTheProduct("4427","none","getPayment",{products:b.basketPull},function(a){b.output.text(printPrice(a.payment))})}};
