...
$c->payment['enabledIds'] = array(
    1,  // оплата наличными
    2,  // оплата банковской картой
    4,  // безналичный расчет (для юридических лиц)
    5,  // онлайн оплата
    6,  // покупка в кредит (онлайн)
    8,  // выставить электронный счёт в личный кабинет Промсвязьбанка
