            ...
            <div class="header__center-inn">
                <div class="header__line header__line_top">
                    <ul class="header-shop-info">
                        <li class="header-shop-info__item"><a href="/walla-retail-shops" class="header-shop-info__link underline">Самовывоз</a></li>
                        <li class="header-shop-info__item"><a href="/walla-retail-delivery" class="header-shop-info__link underline">Доставка</a></li>
                        <li class="header-shop-info__item"><a href="/walla-retail-payment" class="header-shop-info__link underline">Оплата</a></li>
                    </ul>
