...
<footer class="footer">
    <ul class="footer-list">
        <li class="footer-list__item"><a href="/walla-retail-delivery" class="footer-list__link underline">Доставка</a></li>
        <li class="footer-list__item"><a href="/walla-retail-shops" class="footer-list__link underline">Самовывоз</a></li>
        <li class="footer-list__item"><a href="/walla-retail-payment" class="footer-list__link underline">Оплата</a></li>
        <li class="footer-list__item"><a href="/walla-retail-about" class="footer-list__link underline">О компании</a></li>
        <li class="footer-list__item"><a href="/walla-retail-privacy" class="footer-list__link underline">Правовая информация</a></li>
        <li class="footer-list__item"><a href="/walla-retail-offer" class="footer-list__link underline">Оферта</a></li>
    ...
    <div class="footer__left">
        ...
        <div class="footer-copy">&copy; ООО «Валла Ритейл» 2013–<?= date("Y"); ?>. Все права защищены.</div>
    </div>
</footer>
