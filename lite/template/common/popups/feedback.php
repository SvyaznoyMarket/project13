<div class="popup-feedback popup popup_440 js-feedback-popup" style="display: none;">
    ...
    <div class="feedback-complete">
        <div class="popup__title btn-container">Спасибо за ваше обращение!</div>

        <div class="btn-container"><a href="" class="btn-primary btn-primary_bigger js-popup-close">OK</a></div>
    </div>
</div>