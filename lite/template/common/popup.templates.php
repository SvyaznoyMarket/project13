<!-- Попап набор-пакета -->
<div class="popup-set popup popup_920 js-productkit-popup" style="display: none;">
    <div class="popup__close js-popup-close">×</div>

    <div class="js-kit-wrapper"></div>
</div>
<!--/ Попап набор-пакета -->
...
<div class="popup popup_540">
    ...
    <form class="one-click">
        <div class="one-click-product table">
            <div class="one-click-product__img table-cell"><img src="" alt="" class="image"></div>

            <div class="one-click-product__desc table-cell">
                <div class="one-click-product__name"></div>
                <div class="one-click-product__price"></div>
            </div>
        </div>
