...
?>
    ...
    <div class="product-card-rating rating">
        ...
        <a href="#reviews" onclick="$('.jsScrollSpyReviewsLink').click(); return false;"><span class="rating-count dotted"><?= $helper->numberChoiceWithCount($reviewsData['num_reviews'], ['отзыв', 'отзыва', 'отзывов']) ?></span></a>
    </div>
