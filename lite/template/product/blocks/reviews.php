            ...
            <div class="popup-form-success__subscribtion">
                <form class="form-ctrl">
                    <div class="form-ctrl__group">
                        ...
                        <label class="customLabel customLabel-defcheck mChecked" for="subscribe">Подписаться на рассылку и получить купон со скидкой 300&thinsp;<span class="rubl">C</span> на следующую покупку.</label>
                    </div>
                    <div class="form-ctrl__btn-container">
