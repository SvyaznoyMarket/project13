    ...
    <div class="order-payments">
        ...
        <? if (isset($order->possible_payment_methods[PaymentMethod::PAYMENT_CASH]) || isset($order->possible_payment_methods[PaymentMethod::PAYMENT_CARD_ON_DELIVERY])) : ?>
            <div class="paymentRow">
                ...
                <input id="payment-cash" type="radio" name="payment-type[]" value="by_cash" class="custom-input custom-input_radio js-payment-method js-customInput" <?= $checked ? 'checked' : '' ?> />
        ...
        <? if (isset($order->possible_payment_methods[PaymentMethod::PAYMENT_CARD_ONLINE])) : ?>
            <div class="paymentRow jsDeliveryChooseOnline">
                ...
                <input id="payment-online" type="radio" name="payment-type[]" value="by_online" class="custom-input custom-input_radio js-payment-method js-customInput" <?= $checked ? 'checked' : '' ?>>
        ...
        <? if (isset($order->possible_payment_methods[PaymentMethod::PAYMENT_CREDIT])) : ?>
            <div class="paymentRow jsDeliveryChooseCredit">
                ...
                <input id="payment-credit" type="radio" name="payment-type[]" value="by_online_credit" class="customInput customInput-defradio2 js-payment-method js-customInput" <?= $checked ? 'checked' : '' ?>>
