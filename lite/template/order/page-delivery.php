...
return function(
    ...
    <? endif ?>
                            ...
                            <div class="order-delivery-info <?= $order->delivery->point ? 'order-delivery-info_point' : 'order-delivery-info_empty' ?>">
                                ...
                                <? else : ?>
                                    <div class="order-delivery-info-title">
                                        <span class="order-delivery-info-title__left"><?= !empty($point->listName) ? $helper->escape($point->listName) : '' ?></span>
        ...
        <div class="checkout-comment">
            <div class="checkout-comment__title js-order-comment"><span class="dotted">Дополнительные пожелания</span></div>
