            ...
            <div class="grid-transform-4col__row">
                <div class="grid-transform-4col__col col1">
                    <div class="main-categories__item magenta">
                        <a href="/catalog/443" class="main-categories__link">
                ...
                <div class="grid-transform-4col__col col1">
                    <div class="main-categories__item violet">
                        <a href="/catalog/2348" class="main-categories__link">
                ...
                <div class="grid-transform-4col__col col2">
                    <div class="main-categories__item blue">
                        <a href="/catalog/147" class="main-categories__link">
            ...
            <div class="grid-transform-4col__row">
                <div class="grid-transform-4col__col col1">
                    <div class="main-categories__item">
                        <a href="/catalog/1221" class="main-categories__link">
                ...
                <div class="grid-transform-4col__col col2">
                    <div class="main-categories__item orange">
                        <a href="/catalog/354" class="main-categories__link">
                ...
                <div class="grid-transform-4col__col col1">
                    <div class="main-categories__item green">
                        <a href="/catalog/1438" class="main-categories__link">
            ...
            <div class="grid-transform-4col__row">
                <div class="grid-transform-4col__col col1">
                    <div class="main-categories__item olive">
                        <a href="/catalog/2545" class="main-categories__link">
                ...
                <div class="grid-transform-4col__col col1">
                    <div class="main-categories__item blue">
                        <a href="/catalog/966" class="main-categories__link">
                ...
                <div class="grid-transform-4col__col col1">
                    <div class="main-categories__item grey">
                        <a href="/catalog/225" class="main-categories__link">
                ...
                <div class="grid-transform-4col__col col1">
                    <div class="main-categories__item magenta">
                        <a href="/catalog/1193" class="main-categories__link">
