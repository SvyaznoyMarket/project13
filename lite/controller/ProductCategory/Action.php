...
class Action {
     ...
     */
    public function category(\Http\Request $request, $categoryId, $brandToken = null) {
        ...
        if ($brandToken) {
            $params['brand_slug'] = $brandToken;
        }

        \App::scmsClient()->addQuery('category/get/v1', $params, [], function($data) use (&$category, &$catalogJson) {
            if ($data) {
        ...
        \RepositoryManager::productFilter()->prepareCollectionByCategory(
            ...
            $region,
            [],
            function($data) use (&$filters, &$brands, &$brand, $brandToken) {
