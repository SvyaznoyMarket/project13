    ...
    <div class="bGoodItemHead mRounded mBlackBlock clearfix">
        <div class="clearfix">
            <div class="bGoodImgBlock mRounded mFl mW940">
                ...
                <a class="bGoodImgBlock_eEnlarge" href="#" onclick="terminal.core.gui.screen.push('media', {productId: <?= $product->getId() ?>, currentIndex : 0});"></a>
            </div>
        ...
        <div class="bGoodSubItems">
            ...
            <div class="bGoodSubItem">
                <div class="bSlider">
                    ...
                    <div class="bSlider_eWrap clearfix">
                        <? foreach ($related as $iProduct): ?>
                        <!-- terminal.core.gui.screen.push('product', {productId: <?= $iProduct->getId() ?>}) -->
                        <div class="bGoodSubItem_eGoods mFl">
                            <a class="bGoodSubItem_eGoodsImg mFl mRounded" href="#" onclick='terminal.core.gui.screen.push("product", {productId: <?= $iProduct->getId() ?>})'><img width="130" height="130" src="<?= $iProduct->getImageUrl(1) ?>"/></a>
                            <div class="bGoodSubItem_eGoodsInfo">
                                <!-- <p class="bGoodSubItem_eRating"><?= $iProduct->getRating() ?></p> -->
                                <h2 class="bGoodSubItem_eTitle"><a class="bGoodSubItem_eLink" href="#" onclick='terminal.core.gui.screen.push("product", {productId: <?= $iProduct->getId() ?>})'><?= $iProduct->getName() ?></a></h2>
                                <p class="bGoodSubItem_ePrice"><?= $page->helper->formatPrice($iProduct->getPrice()) ?> <span class="bRuble">p</span></p>
                                <a class="bGoodSubItem_eMore bButton mSmallGrayBtn" href="#" onclick='terminal.core.gui.screen.push("product", {productId: <?= $iProduct->getId() ?>})'>Подробнее</a>
                            </div>
                        </div>
                        <? endforeach ?>
                    </div>
            ...
            <? foreach ($warranties as $warranty): ?>
                <div class="bGoodServiceItem clearfix">
                    ...
                    <div class="bFl">
                        ...
                        <a class="bButton mSmallOrangeBtn mFl" href="#" onclick="terminal.cart.setWarranty(<?= $iProduct->getId() ?>, <?= $warranty->getId() ?>)">в корзину</a>
            ...
            <? foreach ($services as $service): ?>
                <div class="bGoodServiceItem clearfix">
                    ...
                    <div class="bFl">
                        ...
                        <a class="bButton mSmallOrangeBtn mFl" href="#" onclick="terminal.cart.addService(<?= $iProduct->getId() ?>, <?= $service->getId() ?>)">в корзину</a>
                        <a class="bButton mSmallGrayBtn mFl" href="#">подробнее</a>
                    </div>
                </div>
            <? endforeach ?>
