...
/**
 * ProductPhoto3D filter form base class.
 *
 * @package    enter
 * @subpackage filter
 ...
 */
abstract class BaseProductPhoto3DFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('product_photo3_d_filters[%s]');
