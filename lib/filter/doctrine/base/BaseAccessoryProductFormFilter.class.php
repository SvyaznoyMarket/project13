...
/**
 * AccessoryProduct filter form base class.
 *
 * @package    enter
 * @subpackage filter
 ...
 */
abstract class BaseAccessoryProductFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('accessory_product_filters[%s]');
