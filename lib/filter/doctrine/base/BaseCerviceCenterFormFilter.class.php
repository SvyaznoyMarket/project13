...
/**
 * CerviceCenter filter form base class.
 *
 * @package    enter
 * @subpackage filter
 ...
 */
abstract class BaseCerviceCenterFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cervice_center_filters[%s]');
