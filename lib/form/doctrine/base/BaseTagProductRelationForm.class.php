...
/**
 * TagProductRelation form base class.
 *
 * @method TagProductRelation getObject() Returns the current form's model object
 *
 * @package    enter
 * @subpackage form
 ...
 */
abstract class BaseTagProductRelationForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tag_product_relation[%s]');
