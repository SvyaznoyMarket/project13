...
/**
 * ServiceCategoryProductTypeRelation form base class.
 *
 * @method ServiceCategoryProductTypeRelation getObject() Returns the current form's model object
 *
 * @package    enter
 * @subpackage form
 ...
 */
abstract class BaseServiceCategoryProductTypeRelationForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('service_category_product_type_relation[%s]');
  ...
  {
    return 'ServiceCategoryProductTypeRelation';
  }
