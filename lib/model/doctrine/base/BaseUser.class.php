 ...
 * @method User                setRegion()         Sets the current record's "Region" value
 ...
 * @method User                setProfile()        Sets the current record's "Profile" collection
 ...
 * @method User                setAddress()        Sets the current record's "Address" collection
 * 
 * @package    enter
 * @subpackage model
...
abstract class BaseUser extends GuardUser
{
    public function setUp()
    {
        ...
        $this->hasMany('UserProfile as Profile', array(
             'local' => 'id',
             'foreign' => 'user_id'));
