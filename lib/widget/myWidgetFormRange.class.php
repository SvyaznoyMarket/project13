...
EOF
  ...
  public function render($name, $value = null, $attributes = array(), $errors = array())
  {
    ...
    return strtr($this->getOption('template'), array(
      '%value_from%' => $this->renderTag('input', array('type' => 'input', 'name' => $name.'[from]', 'value' => $values['from'])),
      '%value_to%'   => $this->renderTag('input', array('type' => 'input', 'name' => $name.'[to]', 'value' => $values['to'])),
