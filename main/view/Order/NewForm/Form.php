...
class Form implements \JsonSerializable {
    ...
    /**
     * @param PartField $part
     */
    public function addPart(PartField $part) {
        $this->part[] = $part;
    }
    ...
    public function setQiwiPhone($qiwiPhone) {
        $qiwiPhone = trim((string)$qiwiPhone);
        $qiwiPhone = preg_replace('/^\+7/', '8', $qiwiPhone);
        $qiwiPhone = preg_replace('/[^\d]/', '', $qiwiPhone);
        if (10 == strlen($qiwiPhone)) {
            $qiwiPhone = '8' . $qiwiPhone;
        }
