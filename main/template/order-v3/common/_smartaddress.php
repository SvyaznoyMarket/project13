<?php return function(
    ...
    <ul class="orderCol_addrs_fld textfield clearfix jsAddressRootNode" style="height: inherit">
        ...
        <li class="orderCol_addrs_fld_i orderCol_addrs_fld_i-edit ui-front">
            <span id="addressInputPrefix" class="addrsAutocmpltLbl" data-bind="text: inputPrefix, visible: inputFocus"></span><input class="jsSmartAddressInput" name="address" type="text" data-bind="visible: inputFocus() && apartmentName() == '', hasFocus: inputFocus" />
        </li>
    </ul>
