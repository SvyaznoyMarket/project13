...
<form class="userInfoEdit clearfix" action="<?= $page->url('user.edit') ?>" class="form" method="post">
    <div class="fl width430">
        ...
        <input type="text" id="user_first_name" value="<?= $form->getFirstName() ?>" name="user[first_name]" class="text width418 mb10" <? if ($form->getIsDisabled()): ?>disabled="disabled"<? endif ?> />

        <label class="userInfoEdit__label" for="user_middle_name">Отчество:</label>

        <input type="text" id="user_middle_name" value="<?= $form->getMiddleName() ?>" name="user[middle_name]" class="text width418 mb10" <? if ($form->getIsDisabled()): ?>disabled="disabled"<? endif ?> />

        <label class="userInfoEdit__label" for="user_last_name">Фамилия:</label>

        <input type="text" id="user_last_name" value="<?= $form->getLastName() ?>" name="user[last_name]" class="text width418 mb10" <? if ($form->getIsDisabled()): ?>disabled="disabled"<? endif ?> />

        <label class="userInfoEdit__label" for="user_sex">Пол:</label>

        <div class="userInfoEdit__checkBox selectbox170">
            <select id="user_sex" name="user[sex]" <? if ($form->getIsDisabled()): ?>disabled="disabled"<? endif ?> >
        ...
        <input type="text" id="user_home_phone" value="<?= $form->getHomePhone() ?>" name="user[home_phone]" class="text" <? if ($form->getIsDisabled()): ?>disabled="disabled"<? endif ?> />
        ...
        <div class="userInfoEdit__checkBox clearfix">
            <div class="checkBox selectbox75 fl">
                ...
                <select id="user_birthday_day" name="user[birthday][day]" <? if ($form->getIsDisabled()): ?>disabled="disabled"<? endif ?>>
            ...
            <div class="checkBox selectbox98 fl">
                ...
                <select id="user_birthday_month" name="user[birthday][month]" <? if ($form->getIsDisabled()): ?>disabled="disabled"<? endif ?>>
            ...
            <div class="checkBox selectbox75 fl">
                ...
                <select id="user_birthday_year" name="user[birthday][year]" <? if ($form->getIsDisabled()): ?>disabled="disabled"<? endif ?>>
