...
<div class="deliv-free-alert jsKnockoutCart" data-bind="visible: isMinOrderSumVisible() && isSelfDeliverySumVisible()" style="display: none;">
    ...
    <div class="deliv-free-alert jsKnockoutCart" data-bind="visible: !isMinOrderSumVisible() && isSelfDeliverySumVisible()" style="display: none;">
        <span class="deliv-free-alert__info">Самовывоз 200 руб., до бесплатного самовывоза осталось</span>
        <span class="deliv-free-alert__remain-sum"><span data-bind="text: selfDeliverySum - cartSum()"><?= \App::config()->selfDeliverySum ?></span>&thinsp;<span class="rubl">p</span></span>
    </div>
