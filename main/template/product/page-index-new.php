        ...
        <div class="bMainContainer bProductSection clearfix">
            ...
            <section class="bProductSection__eLeft">
                <div class="bProductDesc clearfix">
                    <div class="bProductDesc__ePhoto">
                        <figure class="bProductDesc__ePhoto-bigImg">
                            <a class="bigImgLink" href=""><img src="http://fs01.enter.ru/1/1/500/77/142788.jpg" alt="" /></a>
                        </figure>
                        ...
                        <div class="bPhotoAction">
                            ...
                            <div class="bPhotoAction__eOtherPhoto bSliderAction">
                                <ul>
                                    <li>
                                        <a href="">
                                            <figure><img src="http://fs01.enter.ru/1/1/500/77/142788.jpg" alt="" /></figure>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="">
                    ...
                    <div class="bProductDesc__eStore">
                        ...
                        <div class="bProductDesc__eStore-text">
                        	Планшет с экраном 8", 2-ядерным процессором 1,5 ГГц, 1 ГБ оперативной и 16 ГБ встроенной памяти, может проигрывать видео до 7 часов.
                ...
                <div class="bDescriptionProduct">
                    Prestigio MultiPad PMP5880C 8.0 Ultra Duo – в меру мощная рабочая лошадка, готовая сопровождать вас повсюду и работать долго за счет объемного аккумулятора на 6000 мАч. Семь часов видео, 36 часов музыки или десяток Интернета для него не проблема. Двухъядерный процессор и гигабайт оперативной памяти сделают все действия девайса быстрыми и отточенными, а экран с приятным разрешением позволит не напрягать глаза при просмотре фильмов или в играх. На планшете установлена операционная система Android 4.0, которую можно будет обновить до более новой, к 16 гигабайтам встроенной памяти можно прибавить карту типа microSD в два раза больше - и носить с собой сколько заблагорассудится фильмов и документов.
                </div>
            ...
            <aside class="bProductSection__eRight">
                <div class="bWidgetBuy mWidget">
                    ...
                    <div class="bWidgetBuy__eBuy btnBuy"><a class="btnBuy__eLink" href="">В корзину</a></div>
