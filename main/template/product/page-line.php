...
<div class="popup packageSetPopup jsPackageSetPopup">
    ...
    <div class="bPageHead">
        <div class="bPageHead__eSubtitle">Набор мебели</div>
        <div class="bPageHead__eTitle clearfix">
            <h1 itemprop="name">Milan</h1>
        </div>
    </div>

    <div class="packageSetMainImg"><img src="http://fs02.enter.ru/1/1/500/13/276368.jpg" /></div>
        ...
        <div class="packageSet_inner">
            ...
            <div class="packageSetBodyItem">
                ...
                <div class="packageSetBodyItem_desc">
                    ...
                    <div class="column delivery">Доставка <strong>25.02.12</strong></div><!--/ доставка -->
                </div>
            ...
            <!-- элемент комплекта -->
            <div class="packageSetBodyItem mDisabled">
                <a class="packageSetBodyItem_img" href=""><img src="http://fs07.enter.ru/1/1/120/7e/251766.jpg" /></a><!--/ изображение товара -->
    ...
    <div class="packageSetPrice">Итого за 7 предметов: <strong>34 545</strong> <span class="rubl">p</span></div>
