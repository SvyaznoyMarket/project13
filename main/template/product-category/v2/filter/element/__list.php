...
?>
    ...
    <div class="fltrBtn_ln <? if ($option->getImageUrl()): ?>bFilterValuesCol-gbox<? endif ?>">
        <input
            class="customInput <?= $filter->getIsMultiple() ? 'customInput-defcheck2' : 'customInput-defradio2' ?> jsCustomRadio js-customInput <?= $filter->isBrand() ? 'js-category-filter-brand' : '' ?>"
