...
?>
    ...
    <div class="fltrBtn_ln <? if ($option->getImageUrl()): ?>bFilterValuesCol-gbox<? endif ?>">
        <input
            class="customInput <?= $filter->getIsMultiple() ? 'customInput-defcheck2 js-category-v2-filter-element-list-checkbox' : 'customInput-defradio2 js-category-v2-filter-element-list-radio' ?> jsCustomRadio js-customInput <?= $filter->isBrand() ? 'js-category-filter-brand' : '' ?>"
