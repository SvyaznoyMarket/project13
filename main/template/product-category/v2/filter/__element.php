...
return function(
    ...
    switch ($filter->getTypeId()) {
        ...
        case \Model\Product\Filter\Entity::TYPE_SLIDER:
            echo $helper->render('product-category/v2/filter/element/__slider', ['productFilter' => $productFilter, 'filter' => $filter]);
            break;
        case \Model\Product\Filter\Entity::TYPE_LIST:
            echo $helper->render('product-category/v2/filter/element/__list', ['productFilter' => $productFilter, 'filter' => $filter]);
            break;
