...
<div>
    ...
    <div>
        ...
        <div>Мы отправили номер мобильного на номер <b>+7 999 777-11-22<?//= preg_replace('/(\d{1,3})(\d{1,3})(\d{1,2})(\d{1,2})/i', '+7 ($1) $2-$3-$4', $userEntity->getEntity()) // должен быть формат +7 999 777-11-22 ?></b></div>
