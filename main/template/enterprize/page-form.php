    ...
    <fieldset class="formDefault__fields">
        ...
        <ul class="bInputList mEnterPrizeSubscr">
            ...
            <li class="bInputList__eListItem ">
                ...
                <label class="bCustomLabel mCustomLabelBig<? if($form->getAgree()): ?> mChecked<? endif ?>" for="agree">Согласен с <a style="text-decoration: underline;" href="#">условиями оферты</a></label>
            </li>
        </ul>
