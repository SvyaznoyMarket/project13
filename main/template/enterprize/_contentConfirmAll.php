...
<div class="enterprizeConfirm">
    <?php if (!$isEmailConfirmed): ?>
        ...
        <form class="confirmForm jsConfirmEmailRepeatCode" action="<?= \App::router()->generate('enterprize.confirmEmail.create') ?>" method="post">
    ...
    <?php if(!$isPhoneConfirmed): ?>
        ...
        <form class="confirmForm jsConfirmPhoneRepeatCode" action="<?= \App::router()->generate('enterprize.confirmPhone.create') ?>" method="post">
