...
<form class="formDefault jsEnterprizeForm" action="<?=\App::router()->generate($form->getRoute()) ?>" method="post">
    ...
    <fieldset class="formDefault__fields">
        ...
        <input class="formDefault__inputText jsMobile" placeholder="8 (___) ___-__-__" data-mask="+7 (xxx) xxx-xx-xx" type="text" name="user[mobile]" value="<?= $form->getMobile() ?>" <? if ('phone' === $authSource): ?>readonly="readonly"<? endif ?> />
