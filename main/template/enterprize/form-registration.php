...
<form class="formDefault jsEnterprizeForm" action="<?= \App::router()->generate($form->getRoute()) ?>" method="post">
    ...
    <fieldset class="formDefault__fields">
        ...
        <input class="formDefault__inputText jsMobile formDefault__inputText--styled" type="text" name="user[mobile]" placeholder="+7 (___) ___-__-__" data-mask="+7 (xxx) xxx-xx-xx" value="<?= $form->getMobile() ?>" <? if ('phone' === $authSource): ?>readonly="readonly"<? endif ?> />
