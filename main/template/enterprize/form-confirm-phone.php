<form class="confirmForm" action="<?= \App::router()->generate('enterprize.confirmPhone.check') ?>" method="post">
...
<form class="confirmForm" action="<?= \App::router()->generate('enterprize.confirmPhone.create') ?>" method="post">
