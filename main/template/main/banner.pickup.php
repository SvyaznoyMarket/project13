<div class="header-slider">
    ...
    <? if (0 === $bannerNumber): ?>
        <? if (in_array($region->id, [
            ...
            <span class="header-slider__bann stripe-bann">
        ...
        <? elseif (in_array($region->id, [
            ...
            <? if ('/dostavka' !== $pathInfo): ?>
                <a class="header-slider__bann stripe-bann" href="/dostavka">
        ...
        <? elseif (in_array($region->parentId, [
            ...
            <? if ('/delivery' !== $pathInfo && $region->pointCount): ?>
                <a class="header-slider__bann stripe-bann" href="/delivery">
    ...
    <? elseif (1 === $bannerNumber):  ?>
        <a class="header-slider__bann stripe-bann" href="/how_pay">
