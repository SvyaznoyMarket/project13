<ul class='bBuyingFooter'>
    ...
    <li>
        ...
        <span>Наш Контакт-cENTER<br><b><?= \App::config()->company['phone'] ?></b><br> 24 часа в сутки / 7 дней в неделю. Звонок бесплатный. Радость в подарок :)</span>
    </li>
    <li>
    ...
    <li>
        ...
        <h3>Как для себя</h3>
        <span>Вы можете обменять товар в течение 14 дней<br> и в течение 7 дней вернуть в магазин. </span>
    </li>
</ul>
