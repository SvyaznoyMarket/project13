...
<div class="bBuyingSteps" style="display:none" data-bind="style: { display: prepareData() ? 'block' : 'none'}">
	...
	<div class="bBuyingInfo" data-bind="visible: deliveryBoxes().length">
		...
		<div class="bBuyingLine mBuyingFields">
			...
			<div class="bBuyingLine__eRight">
				<input data-validator="<?= $page->json(['required' => true, 'message' => 'Укажите имя получателя']) ?>" type="text" id="order_recipient_first_name" class="bBuyingLine__eText mInputLong" name="order[recipient_first_name]" value="" />
			</div>

			<label for="" class="bBuyingLine__eLeft">Фамилия получателя*</label>
			<div class="bBuyingLine__eRight">
				<input data-validator="<?= $page->json(['required' => true, 'message' => 'Укажите фамилию получателя']) ?>" type="text" id="order_recipient_last_name" class="bBuyingLine__eText mInputLong" name="order[recipient_first_name]" value="" />
			</div>

			<label for="" class="bBuyingLine__eLeft">E-mail*</label>
			<div class="bBuyingLine__eRight">
				<input data-validator="<?= $page->json(['required' => true, 'message' => 'Укажите email получателя']) ?>" type="text" id="order_recipient_email" class="bBuyingLine__eText mInputLong mInput265" name="order[recipient_last_name]" value="" />
			...
			<div class="bBuyingLine__eRight mPhone">
				...
				<input data-validator="<?= $page->json(['required' => true, 'message' => 'Укажите телефон для связи']) ?>" type="text" id="order_recipient_phonenumbers" class="bBuyingLine__eText mInputLong" name="order[recipient_phonenumbers]" value="" />
			</div>
			...
			<div class="bBuyingLine__eRight" style="width: 640px;">
				...
				<div class="bInputAddress ui-css" data-bind="visible: hasHomeDelivery()">
					...
					<input data-validator="<?= $page->json(['required' => true, 'message' => 'Укажите метро']) ?>" type="text" class="bBuyingLine__eText mInputLong ui-autocomplete-input" id="order_address_metro" title="Метро" aria-haspopup="true" aria-autocomplete="list" role="textbox" autocomplete="off" name="order[address_metro]" />
				...
				<div class="bInputAddress">
					...
					<input data-validator="<?= $page->json(['required' => true, 'message' => 'Укажите улицу']) ?>" type="text" id="order_address_street" class="bBuyingLine__eText mInputLong mInputStreet" name="order[address_street]" value="" />
				</div>

				<div class="bInputAddress">
					<label class="bPlaceholder">Дом</label>
					<input data-validator="<?= $page->json(['required' => true, 'message' => 'Укажите дом']) ?>" type="text" id="order_address_building" class="bBuyingLine__eText mInputShort mInputBuild" name="order[address_street]" value="" />
				</div>
		...
		<div class="bBuyingLine">
			...
			<div class="bBuyingLine__eRight bInputList">
				...
				<!-- Privacy and policy -->
				<input data-validator="<?= $page->json(['required' => true, 'message' => 'Вы не приняли условия продажи']) ?>" class="jsCustomRadio bCustomInput mCustomCheckBig" type="checkbox" name="order[agreed]" hidden id="order_agreed"/>
