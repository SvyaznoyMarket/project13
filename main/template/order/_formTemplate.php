    ...
    <div class="bOrderView" data-bind="visible: $root.showForm()" style="display:none">
        ...
        <div id="orderMapPopup" class='popup'>
            ...
            <div class='bMapShops__eList'>
                ...
                <p class="pl20">Регион <?= $user->getRegion()->getName() ?>  ( <a class="jsChangeRegion" data-url="<?= $page->url('region.init') ?>" data-region-id="<?= $user->getRegion()->getId() ?>" href="<?= $page->url('region.change', array('regionId' => $user->getRegion()->getId())) ?>" style="font-weight: normal">изменить</a> )</p>
