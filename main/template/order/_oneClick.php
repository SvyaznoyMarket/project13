...
<div style="width: 900px;">
    ...
    if (\App::config()->analytics['enabled']) {
        ...
        <!-- Efficient Frontiers -->
        <img src="http://pixel.everesttech.net/3252/t?ev_Orders=0&amp;ev_Revenue=0&amp;ev_Quickorders=1&amp;ev_Quickrevenue=<?= $order->getPaySum() ?>&amp;ev_transid=<?= $order->getNumber() ?>" width="1" height="1" />
