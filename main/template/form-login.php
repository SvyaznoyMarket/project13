...
<form id="login-form" action="<?= $page->url('user.login') ?>" class="form" method="post">
    ...
    <div class="fl width327 mr20">
        ...
        <div class="pb5">
            ...
            <input type="text" id="signin_username" class="text width315 mb10" tabindex="1" value="<?= $form->getUsername() ?>" name="signin[username]"/>
        </div>
        ...
        <div class="pb5">
            ...
            <input type="password" id="signin_password" class="text width315 mb10" name="signin[password]" tabindex="2"/>
        </div>
