        ...
        <div class="orderPayment">
            ...
            <div class="orderPayment_block orderPayment_noOnline">
                ...
                <div class="orderPayment_msg orderPayment_noOnline_msg">
                    ...
                    <div class="orderPayment_msg_shop markerList_row">
            ...
            <div class="orderPayment_block orderPayment_noOnline">
                ...
                <div class="orderPayment_msg orderPayment_noOnline_msg">
                    ...
                    <div class="orderPayment_msg_info">
                        ...
                        <div class="orderPaymentWeb_list_sys-logo noFlnoWdt"><img src="/styles/order/img/logo-yamoney.jpg"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="orderPayment_msg orderPayment_noOnline_msg">
                    <div class="orderPayment_msg_head">
                      ...
                      <ul class="orderPaymentWeb_list clearfix">
                        <li>
                            <div class="orderPaymentWeb_list_sys-logo"><img src="/styles/order/img/logo-visa.jpg"></div>
                        ...
                        <li>
                            <div class="orderPaymentWeb_list_sys-logo"><img src="/styles/order/img/logo-paypal.jpg"></div>
                            <button class="orderPayment_btn orderPayment_btn-toggle btn3">Оплатить</button>
                        ...
                        <li>
                            <div class="orderPaymentWeb_list_sys-logo"><img src="/styles/order/img/logo-yamoney.jpg"></div>
                            <button class="orderPayment_btn orderPayment_btn-toggle btn3">Оплатить</button>
                            <a class="orderPaymentWeb_list_sys" href="#">Яндекс.Деньги</a>

                        </li>
                        <li>
                            <div class="orderPaymentWeb_list_sys-logo"> <img src="/styles/order/img/logo-psb.jpg"></div>
                            <button class="orderPayment_btn orderPayment_btn-toggle btn3">Оплатить</button>
