...
class ValidatorError extends \Exception implements \Serializable
{
   ...
   */
  public function __construct(ValidatorAbstract $validator, $code, $arguments = array())
  {
   ...
   *
   * @return ValidatorAbstract A ValidatorAbstract instance
   */
  ...
  public function getArguments($raw = false)
  {
    ...
    foreach ($this->arguments as $key => $value)
    {
      ...
      $arguments["%$key%"] = htmlspecialchars($value, ENT_QUOTES, ValidatorAbstract::getCharset());
    }
