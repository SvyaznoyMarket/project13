...
<div class="allpage" id="page">
  ...
  <div class="allpageinner">
    ...
    <div class="pagehead">
      ...
      <div class="breadcrumbs"><a href="<?php echo url_for('homepage') ?>">Enter.ru</a> &gt; <strong>Помощь
        пользователю</strong></div>
      <?php endif ?>
...
<div class="lightbox">
  <div class="lightboxinner">
    ...
    <ul class="lightboxmenu">
      ...
      <li><a href="<?php echo url_for('cart') ?>" class="point point2"><b></b>Моя корзина<span class="total"
                                                                                               style="display:none;"><span
        id="sum"></span> &nbsp;<span class="rubl">p</span></span></a></li>
    </ul>
  </div>
</div>
<!-- /Lightbox -->
