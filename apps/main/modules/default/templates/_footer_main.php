...
<div class="social_network"><span class="gray font11">Посетите нас</span>
  ...
  <div class="pb5">&copy; &laquo;Enter&raquo; 2011&ndash;<?php echo date("Y") ?>. Все права защищены. <a href='<?php echo url_for('default_show', array('page' => 'terms',)) ?>'>Условия продажи</a> <a href='<?php echo url_for('default_show', array('page' => 'legal',)) ?>'>Правовая информация</a> <a href="<?php echo url_for('user') ?>">Личный кабинет</a></div>
</div>
