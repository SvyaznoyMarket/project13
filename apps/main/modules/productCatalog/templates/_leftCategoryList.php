        ...
        <ul>
            ...
            <?php foreach($root_list['children'] as $level1) { ?>
                ...
                <li class="bCtg__eL2 <?php echo $classCur ; ?>">
                    <a href="<?php echo url_for('productCatalog_category', array("productCategory" => $level1['token'])); ?>">
                        <span>
                            <?php if ($currentDirectory->level > 0 ) { ?>                            
                                <div>-</div>
                            <?php } ?>                                     
                    ...
                    <li class="bCtg__eL3 <?php echo $classCur1; ?>">
                        <a href="<?php echo url_for('productCatalog_category', array("productCategory" => $level2['token'])); ?>">
                    ...
                    <?php foreach($tree[$level2['id']]['children'] as $level3) { ?>
                        ...
                        <li class="bCtg__eL4 <?php echo $classCur2; ?>">
                            <a href="<?php echo url_for('productCatalog_category', array("productCategory" => $level3['token'])); ?>">
