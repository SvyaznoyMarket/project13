<div class="carouseltitle carbig">
  ...
  <div class="scroll" data-quantity="<?php echo $order['related_pager']->getNbResults() ?>">
    (страница <span><?php echo $order['related_pager']->getPage() ?></span> из
    <span><?php echo $order['related_pager']->getLastPage() ?></span>)
