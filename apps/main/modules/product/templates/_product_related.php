<div class="carouseltitle carbig">
  ...
  <div class="scroll" data-quantity="<?php echo $item['related_pager']->getNbResults() ?>">
    ...
    <a title="Предыдущие 3" class="srcoll_link_button back disabled" data-url="<?php echo url_for('product_related', $sf_data->getRaw('product')) ?>" href="javascript:void(0)"></a>
    <a title="Следующие 3" class="srcoll_link_button forvard" data-url="<?php echo url_for('product_related', $sf_data->getRaw('product')) ?>" href="javascript:void(0)"></a>
  </div>
</div>
