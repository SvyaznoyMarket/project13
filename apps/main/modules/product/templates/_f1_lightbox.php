                  ...
                  ?>
                    <tr>
                        ...
                        <td class="bF1Block_eBuy">
                            ...
                            <?php } ?>
                            <input data-url="<?php echo url_for('cart_service_add', array('service' => $service->token, 'product' => $product->token_prefix.'/'.$product->token)) ?>" type="button" class="button yellowbutton" value="Купить услугу">
                        </td>
                    </tr>
             <?php  endforeach ?>
			<tr>
