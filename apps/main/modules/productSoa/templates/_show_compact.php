<div class="goodsbox"<?php echo (isset($ii) && $ii > 3) ? ' style="display:none;"' : '' ?>>
  ...
  <div class="photo">
    ...
    <img src="<?php echo $product['photo'] ?>" alt="<?php echo $product['name'] ?> - <?php //echo $product['root_name'] ?>" title="<?php echo $product['name'] ?> - <?php //echo $product['root_name'] ?>" width="160" height="160" />
    </a>
  </div>
  ...
  <div class="font18 pb10 mSmallBtns"><span class="price"><?php echo $product['priceFormatted'] ?></span> <span class="rubl">p</span></div>
  <!-- Hover -->
