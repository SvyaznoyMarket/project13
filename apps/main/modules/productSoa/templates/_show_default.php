...
<div style="display:none;" id="stock">
  ...
  <img src="<?php echo $photo['path'][3] ?>" alt="" data-url="<?php echo $photo['path'][4] ?>"
...
<div class="goodsinfo bGood">
  <div class="bGood__eArticle">
    <div class="fr">
      ...
      <a href="<?php echo url_for('productComment', array('product' => $product->path)) ?>" class="underline ml5">Читать
...
<div class="fl width500">
  ...
  <ul class="previewlist">
    ...
    <?php foreach ($photos as $i => $photo): ?>
    <li class="viewstock" ref="photo<?php echo $i ?>"><b><a href="<?php echo $photo['path'][4] ?>" class="viewme"
                                                            ref="image"></a></b><img
      src="<?php echo $photo['path'][2] ?>" alt="" width="48" height="48"/></li>
    <?php endforeach ?>
    <?php if (count($p3d) > 0): ?>
...
<div id="order1click-container" class="bMobDown mBR5 mW2 mW900" style="display: none">
  <div class="bMobDown__eWrap">
    ...
    <form id="order1click-form" action="<?php echo url_for('order_1click', array('product' => $product->barcode)) ?>"
          method="post"></form>
