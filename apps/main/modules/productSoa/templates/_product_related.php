<div class="carouseltitle carbig">
  ...
  <div class="scroll" data-quantity="<?php //echo $item['related_pager']->getNbResults() ?>">
    (страница <span>1<?php //echo $item['related_pager']->getPage() ?></span> из
    <span><?php echo $relatedPagesNum; //echo $item['related_pager']->getLastPage() ?></span>)
    <a title="Предыдущие 5" class="srcoll_link_button back disabled"
       data-url="<?php echo url_for('product_related', array('product' => $product->id)) ?>"
