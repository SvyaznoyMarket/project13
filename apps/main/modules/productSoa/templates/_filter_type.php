...
<dl class="bCtg">
  ...
  <dd>
    <ul>
      ...
      <li
        class="bCtg__eL2<?php if ($item['selected']) echo ' mSelected' ?><?php if (!$item['selected'] && ($i > $limit)) echo ' hf' ?>">
        <a href="<?php echo $item['url'] ?>"><span><?php echo $item['name'] ?>
          <b><?php echo $item['count'] ?></b></span></a>
      </li>
      <?php endforeach ?>
    </ul>
  </dd>
