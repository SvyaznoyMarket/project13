<div class="goodsbox"<?php echo (isset($ii) && $ii > $maxPerPage) ? ' style="display:none;"' : '' ?>>
  ...
  <div class="photo">
    <a href="<?php echo url_for('productCardSoa', array('product' => $product)) ?>">
      <img src="<?php echo $product->getMainPhotoUrl(2) ?>"
           ...
           title="<?php echo $product->name ?> - <?php //echo $product->root_name ?>" width="119" height="120"/>
    </a>
  </div>
  ...
  <div class="font18 pb10 mSmallBtns"><span class="price"><?php echo $product->price ?></span> <span
  ...
  <div class="boxhover"<?php if ($product->is_insale): ?> ref="<?php echo $product->token ?>"<?php endif ?>>
    ...
    <div class="rb">
      <div class="lt" data-url="<?php echo url_for('productCardSoa', array('product' => $product->path)) ?>">
        ...
        <div class="font18 pb10 mSmallBtns"><span class="price"><?php echo $product->price ?></span> <span class="rubl">p</span>
        </div>
      </div>
    </div>
  </div>
