...
<form class="search-form" action="<?php echo url_for('search') ?>" method="get">
  ...
  <?php else: ?>
    <input type="text" class="searchtext<?php if (isset($wide)) echo ' width483' ?>" name="q" value="Поиск среди 30 000 товаров" onfocus="if (this.value == 'Поиск среди 30 000 товаров') this.value = '';" onblur="if (this.value == '') this.value = 'Поиск среди 25 000 товаров';" />
  <?php endif ?>
