<form class="product_rating-form event-submit" data-event="form.ajax-submit" data-target=".product_rating_<?php echo $product->id ?>-block" action="<?php echo url_for('userProductRating_create', $sf_data->getRaw('product')) ?>" method="post">
