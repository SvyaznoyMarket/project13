...
<div class="carouseltitle">
  <div class="rubrictitle"><h2><a href="<?php echo $category->getLink() ?>"
                                  class="underline"><?php echo $category->getName()?></a></h2></div>
  ...
  <div class="scroll">
    ...
    <a href="javascript:void(0)" data-url="<?php echo $productTagCategory->dataUrl ?>"
...
<div class="carousel">
  ...
  <?php include_partial('productCatalog_/show_', array('view' => $view, 'ii' => $i, 'item' => $item)) ?>
  <?php endforeach ?>
</div>
<!-- Carousel -->