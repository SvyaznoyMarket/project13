...
<script type="text/html" id="f1cartline">
  <tr ref="<%=fid%>">
    <td>
      <%=f1title%>
      <br>
      <a class="bBacketServ__eMore" href="<?php echo url_for('service_show', array('service' => 'F1ID')); ?>">Подробнее
        об услуге</a>
    </td>
    <td class="mPrice">
    ...
    <td class="mEdit">
      <div class="numerbox mInlineBlock mVAMiddle">
        <a
          ref="<?php echo url_for('cart_service_add', array('service' => 'F1ID', 'quantity' => -1, 'product' => 'PRID')); ?>"
          href="#">
...
<?php if ($item['type'] == 'product'): ?>
  <div class="basketline mWrap" ref="<?php echo $item['token_prefix'] . '/' . $item['token'] ?>">
    ...
    <div class="basketright">
      ...
      <div class="basketinfo pb15">
        <div class="left font11">Цена:<br/><span class="font12"><span
          class="price"><?php echo $item['priceFormatted'] ?></span> <span class="rubl">p</span></span></div>
        <div class="right">
          <div
            class="numerbox"><?php echo ($item['quantity'] > 1) ? link_to('<b class="ajaless" title="Уменьшить"></b>', 'cart_add', array('product' => $item['core_id'], 'quantity' => -1,)) : '<b class="ajaless" title="Уменьшить"></b>' ?>
            <span class="ajaquant"><?php echo $item['quantity'] ?>
              шт.</span><?php echo link_to('<b class="ajamore" title="Увеличить"></b>', 'cart_add', array('product' => $item['core_id'], 'quantity' => 1,)) ?>
          </div>
        </div>
      </div>
      <div class="basketinfo">
        ...
        <div class="right"><a href="<?php echo url_for('cart_delete', array('product' => $item['core_id'])) ?>"
    ...
    <div class="basketright">
      <div class="goodstitle">
        <div class="font24 pb5">
          <a
            href="<?php echo url_for('service_show', array('service' => $item['token'])) ?>"><?php echo $item['name'] ?></a>
        </div>
        <noindex>
          <div class="font11">Есть в наличии</div>
        </noindex>
      ...
      <div class="basketinfo pb15">
        <div class="left font11">Цена:<br/><span class="font12"><span
          class="price"><?php echo (isset($item['priceFormatted'])) ? $item['priceFormatted'] : '' ?></span> <span
          class="rubl">p</span></span></div>
        <div class="right">
          <div class="numerbox">
            ...
            <span class="ajaquant">
              ...
              шт.</span><?php echo link_to('<b class="ajamore" title="Увеличить"></b>', 'cart_service_add', array('service' => $item['token'], 'quantity' => 1,)) ?>
          </div>
        </div>
      </div>
      <div class="basketinfo">
