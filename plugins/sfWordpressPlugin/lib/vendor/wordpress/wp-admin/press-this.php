	...
	switch ($_REQUEST['ajax']) {
		...
		case 'photo_thickbox': ?>
			...
			<p class="centered">
				...
				<a href="#" class="select">
					<img src="<?php echo esc_url($image); ?>" alt="<?php echo esc_attr(wp__('Click to insert.')); ?>" title="<?php echo esc_attr(wp__('Click to insert.')); ?>" />
				</a>
			</p>
		...
		<div class="sleeve">
			...
			<div id="submitdiv" class="postbox">
				...
				<div class="inside">
					...
					<?php
						submit_button( wp__( 'Save Draft' ), 'button', 'draft', false, array( 'id' => 'save' ) );
						if ( current_user_can('publish_posts') ) {
							submit_button( wp__( 'Publish' ), 'primary', 'publish', false );
						} else {
							echo '<br /><br />';
							submit_button( wp__( 'Submit for Review' ), 'primary', 'review', false );
						} ?>
						...
						<div id="category-adder" class="wp-hidden-children">
							<h4>
								<a id="category-add-toggle" href="#category-add" class="hide-if-no-js" tabindex="3">
									<?php printf( wp__( '+ %s' ), $tax->labels->add_new_item ); ?>
								</a>
							</h4>
