...
<div class="changelog point-releases">
	...
	<p><?php printf( _n( '<strong>Version %1$s</strong> addressed some security issues and fixed %2$s bug.',
		...
		<?php printf( wp__( 'For more information, see <a href="%s">the release notes</a>.' ), 'http://codex.wordpress.org/Version_3.3.2' ); ?>
 	</p>
	<p><?php printf( _n( '<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bug.',
		...
		<?php printf( wp__( 'For more information, see <a href="%s">the release notes</a>.' ), 'http://codex.wordpress.org/Version_3.3.1' ); ?>
 	</p>
</div>
...
<div class="changelog">
	...
	<div class="feature-section three-col">
		...
		<div class="last-feature">
			...
			<p><?php printf( wp__( 'WordPress now includes the entire jQuery UI stack and the latest version of jQuery: %s.' ), '1.7.1' ); ?></p>
		</div>
	</div>
...
wp__( 'For more information, see <a href="%s">the release notes</a>.' );
