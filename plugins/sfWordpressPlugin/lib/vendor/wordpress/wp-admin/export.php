...
if ( !current_user_can('export') )
	wp_die(wp__('You do not have sufficient permissions to export the content of this site.'));
...
get_current_screen()->add_help_tab( array(
	...
	'content' => '<p>' . wp__('You can export a file of your site&#8217;s content in order to import it into another installation or platform. The export file will be an XML file format called WXR. Posts, pages, comments, custom fields, categories, and tags can be included. You can choose for the WXR file to include only certain posts or pages by setting the dropdown filters to  limit the export by category, author, date range by month, or publishing status.') . '</p>' .
		'<p>' . wp__('Once generated, your WXR file can be imported by another WordPress site or by another blogging platform able to access this format.') . '</p>',
) );

get_current_screen()->set_help_sidebar(
	'<p><strong>' . wp__('For more information:') . '</strong></p>' .
	'<p>' . wp__('<a href="http://codex.wordpress.org/Tools_Export_Screen" target="_blank">Documentation on Export</a>') . '</p>' .
...
<ul id="post-filters" class="export-filters">
	<li>
		...
		<?php wp_dropdown_categories( array( 'show_option_all' => wp__('All') ) ); ?>
	</li>
	<li>
		<label><?php _e( 'Authors:' ); ?></label>
<?php
		$authors = $wpdb->get_col( "SELECT DISTINCT post_author FROM {$wpdb->posts} WHERE post_type = 'post'" );
		wp_dropdown_users( array( 'include' => $authors, 'name' => 'post_author', 'multi' => true, 'show_option_all' => wp__('All') ) );
?>
	</li>
	<li>
...
<?php
		...
		wp_dropdown_users( array( 'include' => $authors, 'name' => 'page_author', 'multi' => true, 'show_option_all' => wp__('All') ) );
?>
	</li>
	<li>
		<label><?php _e( 'Date range:' ); ?></label>
...
<?php submit_button( wp__('Download Export File'), 'secondary' ); ?>
</form>
</div>
