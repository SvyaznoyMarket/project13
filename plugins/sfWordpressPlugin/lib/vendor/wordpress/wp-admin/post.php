...
case 'edit':
	...
	if ( 'trash' == $post->post_status )
		wp_die( wp__('You can&#8217;t edit this item because it is in the Trash. Please restore it and try again.') );

	if ( null == $post_type_object )
		wp_die( wp__('Unknown post type.') );
...
case 'untrash':
	...
	if ( !current_user_can($post_type_object->cap->delete_post, $post_id) )
		wp_die( wp__('You are not allowed to move this item out of the Trash.') );
