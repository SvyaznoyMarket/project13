...
final class WP_Screen {
	...
	public function show_screen_options() {
		...
		switch ( $this->id ) {
			case 'widgets':
				$this->_screen_settings = '<p><a id="access-on" href="widgets.php?widgets-access=on">' . wp__('Enable accessibility mode') . '</a><a id="access-off" href="widgets.php?widgets-access=off">' . wp__('Disable accessibility mode') . "</a></p>\n";
				break;
		}
	...
	function render_per_page_options() {
		...
		<div class='screen-options'>
			...
			echo get_submit_button( wp__( 'Apply' ), 'button', 'screen-options-apply', false ); ?>
