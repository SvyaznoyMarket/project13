...
<?php
	...
	function bulk_actions() {
		...
		echo "<option value='-1' selected='selected'>" . wp__( 'Bulk Actions' ) . "</option>\n";
		...
		submit_button( wp__( 'Apply' ), 'button-secondary action', false, false, array( 'id' => "doaction$two" ) );
		echo "\n";
	}
...
<?php
	...
	function comments_bubble( $post_id, $pending_comments ) {
		$pending_phrase = sprintf( wp__( '%s pending' ), number_format( $pending_comments ) );
