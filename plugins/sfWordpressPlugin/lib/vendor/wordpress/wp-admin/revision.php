...
case 'diff' :
	...
	$h2 = sprintf( wp__( 'Compare Revisions of &#8220;%1$s&#8221;' ), $post_title );
	$title = wp__( 'Revisions' );
...
default :
	...
	$h2 = sprintf( wp__( 'Revision for &#8220;%1$s&#8221; created on %2$s' ), $post_title, $revision_title );
	$title = wp__( 'Revisions' );
...
<tr id="revision">
	...
	<th scope="col" class="th-full">
		<span class="alignleft"><?php printf( wp__('Older: %s'), wp_post_revision_title( $left_revision ) ); ?></span>
		<span class="alignright"><?php printf( wp__('Newer: %s'), wp_post_revision_title( $right_revision ) ); ?></span>
	</th>
</tr>
<?php endif;
