...
if ( isset($_GET['update']) ) {
	...
	if ( 'updated' == $_GET['update'] )
		$messages[] = wp__('Site info updated.');
}
...
<form method="post" action="site-info.php?action=update-site">
	...
	<table class="form-table">
		...
		<?php
		$attribute_fields = array( 'public' => wp__( 'Public' ) );
		if ( ! $is_main_site ) {
			$attribute_fields['archived'] = wp__( 'Archived' );
			$attribute_fields['spam']     = _x( 'Spam', 'site' );
			$attribute_fields['deleted']  = wp__( 'Deleted' );
		}
		$attribute_fields['mature'] = wp__( 'Mature' );
		?>
		<tr>
