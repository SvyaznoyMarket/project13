...
class Twenty_Eleven_Ephemera_Widget extends WP_Widget {
	...
	function Twenty_Eleven_Ephemera_Widget() {
		$widget_ops = array( 'classname' => 'widget_twentyeleven_ephemera', 'description' => wp__( 'Use this widget to list your recent Aside, Status, Quote, and Link posts', 'twentyeleven' ) );
		$this->WP_Widget( 'widget_twentyeleven_ephemera', wp__( 'Twenty Eleven Ephemera', 'twentyeleven' ), $widget_ops );
	...
	function widget( $args, $instance ) {
		...
		$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? wp__( 'Ephemera', 'twentyeleven' ) : $instance['title'], $instance, $this->id_base);
			...
			<?php while ( $ephemera->have_posts() ) : $ephemera->the_post(); ?>
				...
				<li class="widget-entry-title">
					...
					<span class="comments-link">
						<?php comments_popup_link( wp__( '0 <span class="reply">comments &rarr;</span>', 'twentyeleven' ), wp__( '1 <span class="reply">comment &rarr;</span>', 'twentyeleven' ), wp__( '% <span class="reply">comments &rarr;</span>', 'twentyeleven' ) ); ?>
					</span>
				</li>
