...
function wp_clear_scheduled_hook( $hook, $args = array() ) {
	...
	if ( !is_array($args) ) {
		_deprecated_argument( __FUNCTION__, '3.0', wp__('This argument has changed to an array to match the behavior of the other cron functions.') );
...
function wp_get_schedules() {
	$schedules = array(
		'hourly' => array( 'interval' => 3600, 'display' => wp__('Once Hourly') ),
		'twicedaily' => array( 'interval' => 43200, 'display' => wp__('Twice Daily') ),
		'daily' => array( 'interval' => 86400, 'display' => wp__('Once Daily') ),
	);
