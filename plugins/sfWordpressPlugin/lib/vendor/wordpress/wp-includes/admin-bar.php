...
function wp_admin_bar_wp_menu( $wp_admin_bar ) {
	...
	$wp_admin_bar->add_menu( array(
		...
		'id'        => 'wporg',
		'title'     => wp__('WordPress.org'),
		'href'      => wp__('http://wordpress.org'),
	) );
	...
	$wp_admin_bar->add_menu( array(
		'parent'    => 'wp-logo-external',
		'id'        => 'documentation',
		'title'     => wp__('Documentation'),
		'href'      => wp__('http://codex.wordpress.org'),
	) );
	...
	$wp_admin_bar->add_menu( array(
		'parent'    => 'wp-logo-external',
		'id'        => 'support-forums',
		'title'     => wp__('Support Forums'),
		'href'      => wp__('http://wordpress.org/support/'),
	) );
	...
	$wp_admin_bar->add_menu( array(
		...
		'id'        => 'feedback',
		'title'     => wp__('Feedback'),
		'href'      => wp__('http://wordpress.org/support/forum/requests-and-feedback'),
	) );
}
...
function wp_admin_bar_my_account_item( $wp_admin_bar ) {
	...
	$howdy  = sprintf( wp__('Howdy, %1$s'), $current_user->display_name );
...
function wp_admin_bar_site_menu( $wp_admin_bar ) {
	...
	if ( is_network_admin() ) {
		$blogname = sprintf( wp__('Network Admin: %s'), esc_html( $current_site->site_name ) );
	} elseif ( is_user_admin() ) {
		$blogname = sprintf( wp__('Global Dashboard: %s'), esc_html( $current_site->site_name ) );
	}
...
function wp_admin_bar_appearance_menu( $wp_admin_bar ) {
	...
	if ( current_user_can( 'switch_themes' ) || current_user_can( 'edit_theme_options' ) )
		$wp_admin_bar->add_menu( array( 'parent' => 'appearance', 'id' => 'themes', 'title' => wp__('Themes'), 'href' => admin_url('themes.php') ) );

	if ( ! current_user_can( 'edit_theme_options' ) )
		return;

	if ( current_theme_supports( 'widgets' )  )
		$wp_admin_bar->add_menu( array( 'parent' => 'appearance', 'id' => 'widgets', 'title' => wp__('Widgets'), 'href' => admin_url('widgets.php') ) );

	 if ( current_theme_supports( 'menus' ) || current_theme_supports( 'widgets' ) )
		$wp_admin_bar->add_menu( array( 'parent' => 'appearance', 'id' => 'menus', 'title' => wp__('Menus'), 'href' => admin_url('nav-menus.php') ) );

	if ( current_theme_supports( 'custom-background' ) )
		$wp_admin_bar->add_menu( array( 'parent' => 'appearance', 'id' => 'background', 'title' => wp__('Background'), 'href' => admin_url('themes.php?page=custom-background') ) );

	if ( current_theme_supports( 'custom-header' ) )
		$wp_admin_bar->add_menu( array( 'parent' => 'appearance', 'id' => 'header', 'title' => wp__('Header'), 'href' => admin_url('themes.php?page=custom-header') ) );
}
...
function wp_admin_bar_search_menu( $wp_admin_bar ) {
	...
	$form .= '<input type="submit" class="adminbar-button" value="' . wp__('Search') . '"/>';
	$form .= '</form>';
