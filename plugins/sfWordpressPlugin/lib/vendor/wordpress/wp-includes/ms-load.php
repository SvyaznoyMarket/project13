...
function ms_site_check() {
	...
	if ( '1' == $current_blog->deleted ) {
		if ( file_exists( WP_CONTENT_DIR . '/blog-deleted.php' ) )
			...
			wp_die( wp__( 'This user has elected to delete their account and the content is no longer available.' ), '', array( 'response' => 410 ) );
	}
	...
	if ( '2' == $current_blog->deleted ) {
		if ( file_exists( WP_CONTENT_DIR . '/blog-inactive.php' ) )
			...
			wp_die( sprintf( wp__( 'This site has not been activated yet. If you are having problems activating your site, please contact <a href="mailto:%1$s">%1$s</a>.' ), str_replace( '@', ' AT ', get_site_option( 'admin_email', "support@{$current_site->domain}" ) ) ) );
	}
	...
	if ( $current_blog->archived == '1' || $current_blog->spam == '1' ) {
		if ( file_exists( WP_CONTENT_DIR . '/blog-suspended.php' ) )
			...
			wp_die( wp__( 'This site has been archived or suspended.' ), '', array( 'response' => 410 ) );
	}
